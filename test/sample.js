...
describe('Sample', () => {
    ...
    let aliceIdentity;
    let bobIdentity;
    let usCustomsIdentity; // USA Customs Identifier
    let canCustomsIdentity; // Canadian Customs Identifier
    ...
    beforeEach(() => {
        ...
        return adminConnection.createProfile('defaultProfile', { type : 'embedded' })
            ...
            .then(() => {
                ...
                return businessNetworkConnection.connect('defaultProfile', 'network_03', 'admin', 'adminpw');
            ...
            .then(() => {
                ...
                // Create the network_03 participants.
                const usCustoms = factory.newResource('org.acme.sample', 'CustomsParticipant', 'CUST_01');
                usCustoms.agencyName = 'US Customs and Border Protection';
                usCustoms.country = 'USA';
                const canCustoms = factory.newResource('org.acme.sample', 'CustomsParticipant', 'CUST_02');
                canCustoms.agencyName = 'Canada Border Services Agency';
                canCustoms.country = 'Canada';
                const oneLogistics = factory.newResource('org.acme.sample', 'LogisticsParticipant', 'LOGI_01');
                const logisticsAddress = factory.newConcept('org.acme.sample', 'Address');
                ...
                return businessNetworkConnection.getParticipantRegistry('org.acme.sample.CustomsParticipant')
                    .then((participantRegistry) => {
                        participantRegistry.addAll([usCustoms, canCustoms]);
                    })
                    .then(function () {
                        return businessNetworkConnection.getParticipantRegistry('org.acme.sample.LogisticsParticipant');
                    })
                    .then((logisticsRegistry) => {
                        logisticsRegistry.addAll([oneLogistics]);
                    });
            })
            .then(() => {
            ...
            .then(() => {
                ...
                return businessNetworkConnection.issueIdentity('org.acme.sample.SampleParticipant#alice@email.com', 'alice1')
                    ...
                    .then((identity) => {
                        ...
                        return businessNetworkConnection.issueIdentity('org.acme.sample.CustomsParticipant#CUST_01', 'uscustoms1');
                    })
                    .then((identity) => {
                        usCustomsIdentity = identity; //remove let later
                        return businessNetworkConnection.issueIdentity('org.acme.sample.CustomsParticipant#CUST_02', 'cancustoms1');
                    })
                    .then((identity) => {
                        canCustomsIdentity = identity; //remove let later
                    });
    ...
    function useIdentity(identity) {
        return businessNetworkConnection.disconnect()
            .then(() => {
                ...
                return businessNetworkConnection.connect('defaultProfile', 'network_03', identity.userID, identity.userSecret);
            });
    }

    it('network_03 usCustoms dummy identity use', () => {

        // Use the identity.
        return useIdentity(usCustomsIdentity)
            .then(() => {
    ...
    it('network_03 canCustoms dummy identity use', () => {

        // Use the identity.
        return useIdentity(canCustomsIdentity)
            .then(() => {
